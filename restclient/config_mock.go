...
func (m *MockConfigServiceClient) CreateConfig(arg0 context.Context, arg1 *api.Config, arg2 ...client.CallOption) (*api.Responce, error) {
...
func (m *MockConfigServiceClient) DeleteConfig(arg0 context.Context, arg1 *api.DeleteConfigRequest, arg2 ...client.CallOption) (*api.Responce, error) {
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
...
func (m *MockConfigServiceClient) GetConfigByName(arg0 context.Context, arg1 *api.GetConfigByNameRequest, arg2 ...client.CallOption) (*api.GetConfigResponce, error) {
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
...
func (m *MockConfigServiceClient) GetConfigsByType(arg0 context.Context, arg1 *api.GetConfigsByTypeRequest, arg2 ...client.CallOption) (api.ConfigService_GetConfigsByTypeClient, error) {
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
...
func (m *MockConfigServiceClient) UpdateConfig(arg0 context.Context, arg1 *api.Config, arg2 ...client.CallOption) (*api.Responce, error) {
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
...
func (m *MockConfigService_GetConfigsByTypeClient) Close() error {
...
func (mr *MockConfigService_GetConfigsByTypeClientMockRecorder) Close() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockConfigService_GetConfigsByTypeClient)(nil).Close))
}
